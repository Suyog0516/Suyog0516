          ...
          $format = $_POST['format'];
					...
					if ($uploadOk == 0) {
						...
						if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
							...
							$query=pg_query($conn,"insert into teacher_upload(path,file_name,department_id,year_id,format,submitted_by) values('$file_name_to_save','$full','$department_id','$year_id','$format','$teacher_name')");
							if ($query) {
